...
object config{
    val START_YEAR = 1901
    val MONTH_DAY_BIT = 12
    val LEAPMONTH_NUM_BIT = 13

    val starZodiacName = listOf("摩羯座", "水瓶座", "双鱼座", "白羊座", "金牛座", "双子座", "巨蟹座", "狮子座", "处女座", "天秤座", "天蝎座", "射手座")
    val starZodiacDate = listOf(Pair(1, 20), Pair(2, 19), Pair(3, 21), Pair(4, 21), Pair(5, 21),
            Pair(6, 22), Pair(7, 23), Pair(8, 23), Pair(9, 23), Pair(10, 23), Pair(11, 23), Pair(12, 23))

    val solarTermsNameList = listOf(
        "小寒","大寒","立春","雨水","惊蛰","春分","清明","谷雨",
        "立夏","小满","芒种","夏至","小暑","大暑","立秋","处暑",
        "白露","秋分","寒露","霜降","立冬","小雪","大雪","冬至")

    val eastZodiacList = listOf("玄枵", "娵訾", "降娄", "大梁", "实沈", "鹑首", "鹑火", "鹑尾", "寿星", "大火", "析木", "星纪")
    val the10HeavenlyStems = listOf("甲", "乙", "丙", "丁", "戊", "己", "庚", "辛", "壬", "癸")
    val the10HeavenlyStems5ElementsList = listOf("木", "木", "火", "火", "土", "土", "金", "金", "水", "水")
    val the12EarthlyBranches = listOf<String>("子", "丑", "寅", "卯", "辰", "巳", "午", "未", "申", "酉", "戌", "亥")
    val the12EarthlyBranches5ElementsList = listOf("水", "土", "木", "木", "土", "火", "火", "土", "金", "金", "土", "水")
    val the60HeavenlyEarth = get_60HeavenlyEarth()
    val theHalf60HeavenlyEarth5ElementsList = listOf("海中金", "炉中火", "大林木", "路旁土", "剑锋金", "山头火", "涧下水", "城头土", "白蜡金", "杨柳木", "井泉水",
        "屋上土", "霹雳火", "松柏木", "长流水", "砂中金", "山下火", "平地木", "壁上土", "金箔金", "覆灯火", "天河水",
        "大驿土", "钗钏金", "桑柘木", "大溪水", "砂中土", "天上火", "石榴木", "大海水")
    val the28StarsList = listOf("角木蛟", "亢金龙", "氐土貉", "房日兔", "心月狐", "尾火虎", "箕水豹", "斗木獬", "牛金牛", "女土蝠", "虚日鼠", "危月燕", "室火猪", "壁水貐",
        "奎木狼", "娄金狗", "胃土雉", "昴日鸡", "毕月乌", "觜火猴", "参水猿", "井木犴", "鬼金羊", "柳土獐", "星日马", "张月鹿", "翼火蛇", "轸水蚓")
    val pengTatooList = listOf("甲不开仓 财物耗散", "乙不栽植 千株不长", "丙不修灶 必见灾殃", "丁不剃头 头必生疮", "戊不受田 田主不祥", "己不破券 二比并亡", "庚不经络 织机虚张", "辛不合酱 主人不尝",
    ...
    val chineseZodiacNameList = listOf("鼠", "牛", "虎", "兔", "龙", "蛇", "马", "羊", "猴", "鸡", "狗", "猪")
    val chinese12DayOfficers = "建除满平定执破危成收开闭"
    // 建满平收-黑（黑道）；除危定执-黄（黄道）；成开-皆可用（黄道）；破闭-不可当（黑道）
    val chinese12DayGods = listOf("青龙", "明堂", "天刑", "朱雀", "金贵", "天德", "白虎", "玉堂", "天牢", "玄武", "司命", "勾陈")
    val directionList = listOf("正北", "东北", "正东", "东南", "正南", "西南", "正西", "西北")
    val chinese8Trigrams = "坎艮震巽离坤兑乾"
    // 日天干推算每日吉神方位
    val luckyGodDirection = "艮乾坤离巽艮乾坤离巽"
    val wealthGodDirection = "艮艮坤坤坎坎震震离离"
    val mascotGodDirection = "坎坤乾巽艮坎坤乾巽艮"
    val sunNobleDirection = "坤坤兑乾艮坎离艮震巽"
    val moonNobleDirection = "艮坎乾兑坤坤艮离巽震"
    // 每日胎神
    val fetalGodList = listOf("占门碓外东南", "碓磨厕外东南", "厨灶炉外正南", "仓库门外正南", "房床厕外正南", "占门床外正南", "占碓磨外正南", "厨灶厕外西南", "仓库炉外西南", "房床门外西南",
    ...
    val meridiansName = listOf("胆", "肝", "肺", "大肠", "胃", "脾", "心", "小肠", "膀胱", "肾", "心包", "三焦")

    val lunarMonthNameList = listOf("正月", "二月", "三月", "四月", "五月", "六月", "七月", "八月", "九月", "十月", "冬月", "腊月")
    val lunarDayNameList = listOf("初一", "初二", "初三", "初四", "初五", "初六", "初七", "初八", "初九", "初十",
        "十一", "十二", "十三", "十四", "十五", "十六", "十七", "十八", "十九", "二十",
        "廿一", "廿二", "廿三", "廿四", "廿五", "廿六", "廿七", "廿八", "廿九", "三十")
    val weekDay = listOf("星期日","星期一", "星期二", "星期三", "星期四", "星期五", "星期六")
    // // 1901-2100年二十节气最小公差数序列 向量压缩法
    val encryptionVectorList = listOf<Int>(4, 19, 3, 18, 4, 19, 4, 19, 4, 20, 4, 20, 6, 22, 6, 22, 6, 22, 7, 22, 6, 21, 6, 21)
    ...
    * */
    val SOLAR_TERMS_DATA_LIST = listOf<Long>(
    ...
    */
    ...
    /*  农历数据 每个元素的存储格式如下：
      7~6    5~1
      春节月  春节日*/
    val lunarNewYearList = listOf<Int>(
    ...
    val twohourLuckyTimeList = listOf<Int>(
    ...
    // # 民用三十七事
    val thingsSort = listOf("祭祀", "出行", "移徙", "结婚姻", "宴会", "嫁娶", "安床", "沐浴", "剃头", "修造", "求医疗病", "上表章", "上官", "入学", "冠带", "进人口",
    "裁衣", "竖柱上梁", "经络", "开市", "立券", "交易", "纳财", "修置产室", "开渠", "穿井", "安碓硙", "扫舍宇", "平治道涂", "破屋坏垣", "伐木", "捕捉",
    "畋猎", "栽种", "牧养", "破土", "安葬", "启攒")

    val badGodDic = mapOf(
        "平日" to listOf(
            Triple("亥", listOf("相日", "时德", "六合"), 0),
            Triple("巳", listOf("相日", "六合", "月刑"), 1),
            Triple("申", listOf("相日", "月害"), 2),
            Triple("寅", listOf("相日", "月害", "月刑"), 3),
            Triple("卯午酉", listOf("天吏"), 3),
            Triple("辰戌丑未", listOf("月煞"), 4),
            Triple("子", listOf("天吏", "月刑"), 4)
    ),
        "收日" to listOf(
            Triple("寅申", listOf("长生", "六合", "劫煞"), 0),
            Triple("巳亥", listOf("长生", "劫煞"), 2),
            Triple("辰未", listOf("月害"), 2),
            Triple("子午酉", listOf("大时"), 3),
            Triple("丑戌", listOf("月刑"), 3),
            Triple("卯", listOf("大时"), 4),
        ),
        "闭日" to listOf(
            Triple("子午卯酉", listOf("王日"), 3),
            Triple("辰戌丑未", listOf("官日", "天吏"), 3),
            Triple("寅申巳亥", listOf("月煞"), 4)
        ),
        "劫煞" to listOf(     //# ("寅申", listOf("长生", "六合", "收日"), 0
            Triple("寅申", listOf("长生", "六合"), 0),
            Triple("辰戌丑未", listOf("除日", "相日"), 1), //# ("巳亥", listOf("长生", "月害", "收日"), 2)
            Triple("巳亥", listOf("长生", "月害"), 2),
            Triple("子午卯酉", listOf("执日"), 3)
        ),
        "灾煞" to listOf(
            Triple("寅申巳亥", listOf("开日"), 1),
            Triple("辰戌丑未", listOf("满日", "民日"), 2),
            Triple("子午", listOf("月破"), 4),
            Triple("卯酉", listOf("月破", "月厌"), 5)
        ),
        "月煞" to listOf(
            Triple("卯酉", listOf("六合", "危日"), 1),
            Triple("子午", listOf("月害", "危日"), 3),
        //# ("寅申巳亥", listOf("闭日"), 4),
        //# ("辰戌丑未", listOf("平日"), 4)
    ),
        "月刑" to listOf(
            Triple("巳", listOf("平日", "六合", "相日"), 1),
            Triple("寅", listOf("相日", "月害", "平日"), 3),
            Triple("辰酉亥", listOf("建日"), 3),               //# ("丑戌", listOf("收日"), 3),
            Triple("子", listOf("平日", "天吏"), 4),
            Triple("卯", listOf("收日", "大时", "天破"), 4),
            Triple("未申", listOf("月破"), 4),
            Triple("午", listOf("月建", "月厌", "德大会"), 4)
        ),
        "月害" to listOf(
            Triple("卯酉", listOf("守日", "除日"), 2),
            Triple("丑未", listOf("执日", "大时"), 2),
            Triple("巳亥", listOf("长生", "劫煞"), 2),
            Triple("申", listOf("相日", "平日"), 2),
            Triple("子午", listOf("月煞"), 3),
            Triple("辰戌", listOf("官日", "闭日", "天吏"), 3),
            Triple("寅", listOf("相日", "平日", "月刑"), 3)
        ),
        "月厌" to listOf(
            Triple("寅申", listOf("成日"), 2),
            Triple("丑未", listOf("开日"), 2),
            Triple("辰戌", listOf("定日"), 3),
            Triple("已亥", listOf("满日"), 3),
            Triple("子", listOf("月建", "德大会"), 4),
            Triple("午", listOf("月建", "月刑", "德大会"), 4),
            Triple("卯酉", listOf("月破", "灾煞"), 5)
        ),
        "大时" to listOf(
            Triple("寅申已亥", listOf("除日", "官日"), 0),
            Triple("辰戌", listOf("执日", "六合"), 0),
            Triple("丑未", listOf("执日", "月害"), 2),
            Triple("子午酉", listOf("收日"), 3),
            Triple("卯", listOf("收日", "月刑"), 4)
        ),
        "天吏" to listOf(
            Triple("寅申已亥", listOf("危日"), 2),
            Triple("辰戌丑未", listOf("闭日"), 3),
            Triple("卯午酉", listOf("平日"), 3),
            Triple("子", listOf("平日", "月刑"), 4)
    )
    )

    // # 神煞宜忌准备
    val bujiang = listOf("壬寅壬辰辛丑辛卯辛巳庚寅庚辰丁丑丁卯丁巳戊寅戊辰", "辛丑辛卯庚子庚寅庚辰丁丑丁卯丙子丙寅丙辰戊子戊寅戊辰", "辛亥辛丑辛卯庚子庚寅丁亥丁丑丁卯丙子丙寅戊子戊寅",
    ...
    val day8CharThing = mapOf(
        "甲" to Pair(listOf(""), listOf("开仓")),
        "乙" to Pair(listOf(), listOf("栽种")),
        "丁" to Pair(listOf(), listOf("整容", "剃头")),
        "庚" to Pair(listOf(), listOf("经络")),
        "辛" to Pair(listOf(), listOf("酝酿")),
        "壬" to Pair(listOf(), listOf("开渠", "穿井")),
        "子" to Pair(listOf("沐浴"), listOf()),  //# 亥子日宜沐浴
        "丑" to Pair(listOf(), listOf("冠带")),
        "寅" to Pair(listOf(), listOf("祭祀")),
        "卯" to Pair(listOf(), listOf("穿井")),
        "酉" to Pair(listOf(), listOf("宴会")),
        "巳" to Pair(listOf(), listOf("出行")),
        "午" to Pair(listOf(), listOf("苫盖")),
        "未" to Pair(listOf(), listOf("求医疗病")),
        "申" to Pair(listOf(), listOf("安床")),
        "亥" to Pair(listOf("沐浴"), listOf("嫁娶"))  //# 亥子日宜沐浴
    )
    val officerThings = mapOf(
        "建" to Pair(arrayListOf("施恩", "招贤", "举正直", "出行", "上官", "临政"), arrayListOf("")),
        "除" to Pair(arrayListOf("解除", "沐浴", "整容", "剃头", "整手足甲", "求医疗病", "扫舍宇"), arrayListOf()),
        "满" to Pair(arrayListOf("进人口", "裁制", "竖柱上梁", "经络", "开市", "立券交易", "纳财", "开仓", "塞穴", "补垣"),
            arrayListOf("施恩", "招贤", "举正直", "上官", "临政", "结婚姻", "纳采", "求医疗病")),
        "平" to Pair(arrayListOf("修饰垣墙", "平治道涂"),
            arrayListOf("祈福", "求嗣", "上册", "上表章", "颁诏", "施恩", "招贤", "举正直", "宣政事", "布政事", "庆赐", "宴会", "冠带", "出行", "安抚边境", "选将",
                "出师", "上官", "临政", "结婚姻", "纳采", "嫁娶", "进人口", "搬移", "安床", "解除", "求医疗病", "裁制", "营建", "修宫室", "缮城郭",
                "筑堤防", "修造", "竖柱上梁", "修仓库", "鼓铸", "经络", "酝酿", "开市", "立券交易", "纳财", "开仓", "修置产室", "开渠", "穿井", "栽种",
                "牧养", "纳畜", "破土", "安葬", "启攒")),
        "定" to Pair(arrayListOf("冠带"),arrayListOf()),
        "执" to Pair(arrayListOf("捕捉"), arrayListOf()),
        "破" to Pair(arrayListOf("求医疗病"),arrayListOf()),
        "危" to Pair(arrayListOf("安抚边境", "选将", "安床"),arrayListOf()),
        "成" to Pair(arrayListOf("入学", "安抚边境", "搬移", "筑堤防", "开市"),arrayListOf()),
        "收" to Pair(arrayListOf("进人口", "纳财", "捕捉", "纳畜"),
            arrayListOf("祈福", "求嗣", "上册", "上表章", "颁诏", "施恩", "招贤", "举正直", "宣政事", "布政事", "庆赐", "宴会", "冠带", "出行", "安抚边境", "选将",
            "出师", "上官", "临政", "结婚姻", "纳采", "嫁娶", "搬移", "安床", "解除", "求医疗病", "裁制", "营建", "修宫室", "缮城郭", "筑堤防", "修造",
            "竖柱上梁", "鼓铸", "经络", "酝酿", "开市", "立券交易", "开仓", "修置产室", "开渠", "穿井", "破土", "安葬", "启攒")
    ),
        "开" to Pair(
            arrayListOf("祭祀", "祈福", "求嗣", "上册", "上表章", "颁诏", "覃恩", "施恩", "招贤", "举正直", "恤孤茕", "宣政事", "雪冤", "庆赐", "宴会", "入学",
                "出行", "上官", "临政", "搬移", "解除", "求医疗病", "裁制", "修宫室", "缮城郭", "修造", "修仓库", "开市", "修置产室", "开渠", "穿井", "安碓硙", "栽种",
                "牧养"), arrayListOf()),
        "闭" to Pair(arrayListOf("筑堤防", "塞穴", "补垣"),
            arrayListOf("上册", "上表章", "颁诏", "施恩", "招贤", "举正直", "宣政事", "布政事", "庆赐", "宴会", "出行", "出师", "上官", "临政", "结婚姻", "纳采",
                "嫁娶", "进人口", "搬移", "安床", "求医疗病", "疗目", "营建", "修宫室", "修造", "竖柱上梁", "开市", "开仓", "修置产室", "开渠", "穿井")),
    )

    val levelDic = mapOf(0 to "上：吉足胜凶，从宜不从忌。", 
        1 to "上次：吉足抵凶，遇德从宜不从忌，不遇从宜亦从忌。", 
        2 to "中：吉不抵凶，遇德从宜不从忌，不遇从忌不从宜。", 
        3 to "中次：凶胜于吉，遇德从宜亦从忌，不遇从忌不从宜。", 
        4 to "下:凶又逢凶，遇德从忌不从宜，不遇诸事皆忌。", 
        5 to "下下：凶叠大凶，遇德亦诸事皆忌。（卯酉月，灾煞遇月破、月厌，月厌遇灾煞、月破）", 
        -1 to "无")

    val thingLevelDic = mapOf(0 to "从宜不从忌", 1 to "从宜亦从忌", 2 to "从忌不从宜", 3 to "诸事皆忌")
    val mrY13 = listOf(Pair(1, 13), Pair(2, 11), Pair(3, 9), Pair(4, 7), Pair(5, 5),
        Pair(6, 2), Pair(7, 1), Pair(7, 29), Pair(8, 27), Pair(9, 25), Pair(10, 23),
        Pair(11, 21), Pair(12, 19))

    private fun get_60HeavenlyEarth(): ArrayList<String> {
        val jz = ArrayList<String>()
        for (i in 0..59){
            jz.add(the10HeavenlyStems[i % 10] + the12EarthlyBranches[i % 12])
        }
        return jz
    }
}